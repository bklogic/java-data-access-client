...
import net.backlogic.persistence.client.classicmodel.ClassicCommand;
import net.backlogic.persistence.client.classicmodel.ClassicQuery;
...
import net.backlogic.persistence.client.classicmodel.OrderRepository;
...
public class PersistenceClientTest {
	...
	public static void setUpBeforeClass() throws Exception {
		handler = new MockServiceHandler("http://loclahost/acct/app");
